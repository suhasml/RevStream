...
//   useEffect(() => {
//     // Fetch chart data
//     axios.post('http://localhost:8002/generate-charts', { time_range: timeRange })
//       .then((response) => {
...
//     axios.post('http://localhost:8002/review-analysis', { time_range: timeRange })
//       .then((response) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch review analysis data
        const analysisResponse = await axios.post('http://localhost:8002/review-analysis', { time_range: timeRange });
