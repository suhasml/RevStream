...
// const WellnessEventCard = ({ event, index, isOpen, toggle }) => {
//   return (
...
//             ))}
//           </ul>
//           <CButton color="primary" onClick={() => handleSelectEvent(event.title)}>
//             Select Event
//           </CButton>
//         </CCardBody>
//       </CCollapse>
...
//     // Make API request to book the event
//     console.log(`Booking event: ${eventTitle}`)
//     // Example: fetch('/api/book-event', { method: 'POST', body: JSON.stringify({ event: eventTitle }) })
//   }
