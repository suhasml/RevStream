...
/**
 * Login Component
 * Renders a login form allowing users to sign in using their email and booking reference number.
 * It handles user input, submits the login credentials to the server, and navigates the user to their profile upon successful authentication.
 * Displays an error message for invalid login attempts.
 */
const Login = () => {
  const navigate = useNavigate();
  ...
  /**
   * Handles the submission of the login form.
   * Attempts to authenticate the user with the provided credentials (email and booking reference).
   * Navigates to the user profile on successful login or sets an error message on failure.
   * @param {Object} e - The event object from the form submission.
   */
  const handleLoginSubmit = async (e) => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto p-4 flex justify-center min-h-[600px] items-center">
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500">
                Log in with your email and booking reference
              </p>
            </div>
            <div className="mb-6">
              <input
            ...
            <div className="mb-6">
              <input
                ...
                value={loginData.bookingReference}
                onChange={handleInputChange}
                autoComplete="booking-ref"
                className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white"
              />
            </div>
            {errorMessage && (
      ...
      <div className="bg-slate-50 flex flex-col mx-auto w-full max-w-lg px-4">
        ...
        <small className="text-slate-600">Booking Reference: ref123</small>
      </div>
    </>
  );
};
