...
import tshirtImg from 'assets/merchandise/tshirt.jpg';
import jacketImg from 'assets/merchandise/jacket.jpg';
import capImg from 'assets/merchandise/cap.png';
...
const Merchandise = () => {
  ...
  const merchItems = [
    { id: 1, name: 'T-Shirt', price: '$20', options: ['S', 'M', 'L', 'XL'], image: tshirtImg },
    { id: 2, name: 'Jacket', price: '$50', options: ['S', 'M', 'L'], image: jacketImg },
    { id: 3, name: 'Cap', price: '$15', options: ['One Size'], image: capImg },
  ];
  ...
  return (
    ...
    <div className="container mx-auto p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 bg-white">
      {merchItems.map((item) => (
        <div key={item.id} className="bg-white shadow-lg p-4 object-contain rounded-lg hover:shadow-xl cursor-pointer" onClick={() => handleSelectMerch(item)}>
      ...
      {selectedMerch && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full relative">
            ...
            <img src={selectedMerch.image} alt={selectedMerch.name} className="w-full h-80 object-cover rounded-lg mb-4" />
